...
```
# Create Folder
mkdir /home/anand/.ssh/aks-prod-sshkeys-terraform
...
ssh-keygen \
    ...
    -f /home/anand/.ssh/aks-prod-sshkeys-terraform/aksprodsshkey \
    -N mypassphrase

# List Files
ls -lrt /home/anand/.ssh/aks-prod-sshkeys-terraform
```
...
variable "ssh_public_key" {
  default = "/home/anand/.ssh/aks-prod-sshkeys-terraform/aksprodsshkey.pub"
...
```
# Change Directory 
cd Create-AKS-Cluster/terraform-manifests-aks
...
```
# Change Directory 
cd Create-AKS-NodePools-using-Terraform/terraform-manifests-aks
...
## Step-06: Deploy Sample Applications for all 2 node pools
- Webserver App to System Nodepool
- Dotnet App to Windows Nodepool
```
# Change Directory 
cd Create-AKS-NodePools-using-Terraform/
